...
const Register = () => {
    ...
    const sendUserData = async () => {
        ...
        const response = await UsersManager.register(userInformation, setCreated, setNotCreated)
    ...
    return <>
            ...
            <div className="centerContainerLogin">
                ...
                <div className="centerLogin" >
                    <div className="centerLogin">
                        ...
                        <p className="passwordText">La contraseña debe tener un mínimo de 8 caracteres, una letra en mayúscula y un número al menos.</p>
        ...
        {created && <Modal title={"Bienvenido"} text={`${name.toUpperCase()} ya formas parte de la familia McDowell. Te enviaremos por email el ticket de tu pedido, gracias por tu compra`} route={()=>sendOrder()}/>}
        {notCreated && <Modal title={"Datos erroneos"} text={"Aqui va el mensaje de los validadores..."} route={()=>setNotCreated(!notCreated)}/>}
    </>
